...
const OrderRedirectModal: React.FC<OrderRedirectModalProps> = ({ isOpen, onClose, onConfirm }) => {
                ...
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-6 pointer-events-none">
                    ...
                    >
                        <div className="w-20 h-20 bg-accent/10 text-accent rounded-full flex items-center justify-center mx-auto mb-8">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"></path><path d="M3 6h18"></path><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
                        </div>
                        
                        <h3 className="text-2xl font-serif mb-4 text-foreground">Order via GoFood?</h3>
                        <p className="text-foreground/60 mb-10 leading-relaxed">
                            You will be redirected to our official <span className="font-bold text-foreground">GoFood Sukabumi</span> store to complete your purchase.
                        </p>
